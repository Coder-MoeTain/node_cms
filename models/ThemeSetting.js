...
module.exports = (sequelize) =>
  sequelize.define('ThemeSetting', {
    ...
    logo_max_height: { type: DataTypes.INTEGER.UNSIGNED, defaultValue: 64 },
    logo_max_width: { type: DataTypes.INTEGER.UNSIGNED, defaultValue: 180 },
    logo_placement: { type: DataTypes.STRING(20), defaultValue: 'left' },
